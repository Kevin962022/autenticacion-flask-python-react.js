	...
	return (
            <form className="row g-3 text-start" onSubmit={handleSubmit}>
                <div className="col-md-12">
                    ...
                    <input value={data.email} name="email" type="email" className="form-control" id="email" onChange={handleData} required/>
                </div>
                <div className="col-md-12">
                    <label htmlFor="pass" className="form-label fw-semibold">Password</label>
                    <input value={data.password} name="password" type="password" className="form-control" id="pass" onChange={handleData} required/>
                </div>
                <div className="col-md-12">
